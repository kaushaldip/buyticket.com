...

{
	...
	$user_id = $session['TEIMJSIYOG'.'user_id'];

	$admin_user_id = $session['TEIMJSIYOGadmin_user_id'];

    

    

    if(!is_dir('/ckfinder_userfiles/'.$user_id))

            mkdir('/ckfinder_userfiles/'.$user_id,0777);
...
/*
// /home/bea4/public_html 
// C:/wamp/www/
$baseUrl = '/ckfinder_userfiles/';
$baseDir = resolveUrl($baseUrl);
*/
//http://es3/accounted4/assets/ckfinder/core/connector/php/connector.php?command=Init&type=Images&langCode=en
//http://www.beaccounted4.com/assets/ckfinder/core/connector/php/connector.php?command=Init&type=Images&langCode=en
if(($_SERVER['HTTP_HOST'] == 'buyticket.com'))
{
	$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].'/ckfinder_userfiles/'.$user_id.'/';
    $baseDir = '/home/buyticket/public_html/ckfinder_userfiles/'.$user_id.'/';
	
}
else
{
	$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].'/buyticket/ckfinder_userfiles/'.$user_id.'/';
	$baseDir = 'D:/wamp/www/buyticket/ckfinder_userfiles/'.$user_id.'/';
}
