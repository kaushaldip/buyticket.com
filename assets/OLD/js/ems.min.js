...
{  
    ...
    function(data)
    {
        ...
        if(result=='error')
        {
            $("#add_referral_url_response").html('<div class="alert alert-error"><a class="close" data-dismiss="alert">x</a>'+message+'</div>')
            return false;
            ...
            $("#add_referral_url_response").html('<div class="alert alert-success"><a class="close" data-dismiss="alert">x</a>'+result+'</div>');
        }
    });
}
    ...
    if(confirm(msg))
    {
        ...
        function(data)
        {
            ...
            {               
                ...
                $("#add_referral_url_response").html('<div class="alert alert-success"><a class="close" data-dismiss="alert">x</a>'+message+'</div>');
            }
        });
    }
}
...
function join_affiliate_event(site_url,event_id,organizer_id,affiliate_rate)
{
    ...
    {
        root_url = site_url.slice(0,-3);
        $("#join_a_event_"+event_id).html('<img src='+root_url+'/assets/images/ajax_loader_small.gif>');
