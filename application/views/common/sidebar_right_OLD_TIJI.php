...
<div class="span4">
    <div class="box">
        	<h1><?php echo $this->lang->line('event_location'); ?></h1>
	...
	<div class="box">
        	<h1><?php echo $this->lang->line('date_range'); ?></h1>
            <div class="box_content">
            	<ul class="right_menu">
    ...
    <div class="box">
        	<h1><?php echo $this->lang->line('price'); ?></h1>
            <div class="box_content">
            	<ul class="right_menu">
    ...
    <div class="box">
        	<h1><?php echo $this->lang->line('gender'); ?></h1>
            <div class="box_content">
            	<ul class="right_menu">
    ...
    <div class="box">
        	<h1><?php echo $this->lang->line('event_catalog'); ?></h1>
            <div class="box_content">
            	<ul class="right_menu">
    ...
    <div class="box">
        	<h1><?php echo $this->lang->line('event_types'); ?></h1>
            <div class="box_content">
            	<ul class="right_menu">
