<?php echo $this->load->view('common/head');?>
    ...
    <?php if(strtolower($banner)=="yes"){
        echo $this->load->view('common/general_banner');
    } ?>
    ...
    <script type="text/javascript" src="<?php echo MAIN_JS_DIR_FULL_PATH; ?>jquery_mixitup.js"></script>
