...
class Admin extends CI_Controller {
	...
	{
		$this->data['details_data'] = $this->admin_testimonial->get_details();
		
		//$this->data = '';
		$this->template
			->set_layout('dashboard')
			->enable_parser(FALSE)
			->title(SITE_NAME.' - Testimonial Management')
	...
	public function add()
	{
		...
		$img_full_path = TESTIMONIAL_PATH.$image_data['file_name'];
		...
		$this->template
			->set_layout('dashboard')
			->enable_parser(FALSE)
			->title(SITE_NAME.' - Add Testimonial')
	...
	public function edit($id)
	{
		...
		$this->template
			->set_layout('dashboard')
			->enable_parser(FALSE)
			->title(SITE_NAME.' - Edit Testimonial')
