    ...
    <div class="container">
        ...
        <div class="row">        
            <div class="col-md-12">
                ...
                <?php 
                $all_how_cms =  $this->general->get_how_lists_referral();if($all_how_cms)
                {
                    for($i=0;$i<3;$i++)
                    {
...
<div class="center container">
	<h2 class="title-post"><?=$this->lang->line('market_buyticket_make_money'); ?></h2>
	<p><?=$this->lang->line('join_refferal_system_make_money'); ?></p>
	<a href="<?=site_url("join") ?>" class="get-started"><?php echo $this->lang->line('join_referral_program'); ?></a>
</div>
