...
class Payments_pro extends CI_Controller 
{
	...
	function Do_direct_payment()
	{
		...
		$CCDetails = array(
							...
							'expdate' => '102013', 							// Required.  Credit card expiration date.  Format is MMYYYY
		...
		$PayerInfo = array(
							'email' => 'ajayogal@gmail.com', 								// Email address of payer.
							'payerid' => '', 							// Unique PayPal customer ID for payer.
							'payerstatus' => '', 						// Status of payer.  Values are verified or unverified
							'business' => 'Esignature' 							// Payer's business name.
						);
						
		$PayerName = array(
							'salutation' => 'Mr', 						// Payer's salutation.  20 char max.
							'firstname' => 'Ajay', 							// Payer's first name.  25 char max.
							'middlename' => 'Yogal', 						// Payer's middle name.  25 char max.
							'lastname' => 'Shrestha', 							// Payer's last name.  25 char max.
							'suffix' => ''								// Payer's suffix.  12 char max.
						);
						
		$BillingAddress = array(
								'street' => 'Chandol', 						// Required.  First street address.
								'street2' => '', 						// Second street address.
								'city' => 'Kathamdu', 							// Required.  Name of City.
								'state' => 'Bagmati', 							// Required. Name of State or Province.
								'countrycode' => 'NEP', 					// Required.  Country code.
								'zip' => '00977', 							// Required.  Postal code of payer.
								'phonenum' => '9851139952' 						// Phone Number of payer.  20 char max.
							);
