    		...
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item small">
                        <input name="performer_type" type="text" id="performer_type" value="<?php echo set_value('performer_type');?>" class="mws-textinput" onkeyup="lookup(this.value,'category');" onblur="close_this('category');"/>
