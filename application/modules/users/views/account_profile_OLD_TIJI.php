...
<ul class="nav nav-tabs">
    <li <?php if($this->uri->segment(2) == 'index' || $this->uri->segment(2)==''){echo ' class="active"';} ?> ><a href="<?php echo site_url('users/account/index');?>" class="upload"><span><?php echo $this->lang->line('view_profile');?></span></a></li>
    <li <?php if($this->uri->segment(2) == 'editprofile'){echo ' class="active"';} ?> ><a href="<?php echo site_url('users/account/editprofile');?>" class="upload"><span><?php echo $this->lang->line('update_profile');?></span></a></li>
    <!--
    ...
    -->
    <li <?php if($this->uri->segment(2) == 'changepassword'){echo ' class="active"';} ?>><a href="<?php echo site_url('users/account/changepassword');?>" class="ch_pass"><span><?php echo $this->lang->line('change_password');?></span></a></li>
    <li <?php if($this->uri->segment(2) == 'closeaccount'){echo ' class="active"';} ?>><a href="<?php echo site_url('users/account/closeaccount');?>" class="ch_pass"><span><?php echo $this->lang->line('close_account');?></span></a></li>
</ul>
...
<?php  } ?>	
<div class="box">
    <h1><?php echo $this->lang->line('account_information'); ?></h1>
...
<div class="box">
    <h1><?php echo $this->lang->line('work_information'); ?></h1>
    <div class="box_content">        
        <ul class="for_info">        
            <li>
...
<div class="box">
    <h1><?php echo $this->lang->line('bank_information'); ?></h1>
    <div class="box_content">        
        <ul class="for_info">        
            <li>
...
<div class="box">
    <h1><?php echo $this->lang->line('email_preference'); ?></h1>
    <div class="box_content">        
        <ul class="for_info">            
            <li>
