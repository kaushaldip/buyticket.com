<div class="breadcum">
    <div class="breadcum_inside">
        <a href="<?=	site_url(ADMIN_DASHBOARD_PATH)?>">Dashboard</a> &raquo; <a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/help/index">Help Management</a> &raquo; Add
...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
    	<span class="mws-i-24 i-list">Add New Help</span>
    </div>
    		...
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item small">
                        <input name="name" type="text" class="mws-textinput" id="name" value="<?php echo set_value('name');?>" size="55" />
                        <?=form_error('name')?>
    				</div>
    			</div>
                <div class="mws-form-row">
    				...
    				<div class="mws-form-item small">
                        <ul class="mws-form-list inline">
    						...
    						<li><input  style="text-align: right;" name="is_display" type="radio" value="No" <?php if($this->input->post('is_display') == 'No'){ echo 'checked="checked"';}?> /> <label>No</label></li>    						
    					</ul>
    				</div>
    			</div>
                <div class="mws-form-row">
    				...
    				<div class="mws-form-item small">  
                        <textarea name="description" cols="75" rows="7"><?php echo set_value('description');?></textarea>
