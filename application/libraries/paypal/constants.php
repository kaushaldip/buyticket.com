...
define('API_USERNAME','esajayyogal-seller_api1.gmail.com');// 'dshouldice_api1.rtm-inc.com');
//
...
define('API_PASSWORD', '1369135870');// 'DRHVNS9YSF9QESXG');

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE','AGfuTiKPsjWJdf1Pth6T6ke6d0QdA7J4R4yCkCyicCW-m0oXfpATZ81G');// 'AJVmvg1gPnjm9KB00hSx-wt9VUCWAA-syOjv.f08fVzx4tbgHfqtxqf4');

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/

define('API_ENDPOINT', 'https://api-3t.sandbox.paypal.com/nvp');// 'https://api-3t.paypal.com/nvp');
